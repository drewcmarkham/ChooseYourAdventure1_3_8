...
public class ChooseYourAdventure {
    public static void main(String[] args) {
        ...
        System.out.println("Type \"T\" to stay in your house \nType \"F\" to leave and try to find better shelter");
